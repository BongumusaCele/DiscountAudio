...
if (isset($_GET['delete'])) {
    ...
    mysqli_query($conn, "DELETE FROM `tblbookings` WHERE id = '$delete_id'") or die('query failed');
...
<body>
    ...
    <section class="messages">
        ...
        <div class="box-container">
            <?php
            $select_message = mysqli_query($conn, "SELECT * FROM `tblbookings`") or die('query failed');
            ...
            ?>
                    <div class="box">
                        ...
                        <p> service type : <span><?php echo $fetch_message['servicetype']; ?></span> </p>
                        <a href="admin_contacts.php?delete=<?php echo $fetch_message['id']; ?>" onclick="return confirm('delete this message?');" class="delete-btn">delete booking</a>
                    </div>
            <?php
                };
            } else {
