...
if (isset($_POST['add_book'])) {
    ...
    $select_product_name = mysqli_query($conn, "SELECT name FROM `tblaudioproducts` WHERE name = '$name'");
    ...
    if (mysqli_num_rows($select_product_name) > 0) {
        ...
        $add_product_query = mysqli_query($conn, "INSERT INTO `tblaudioproducts`(name, price, image) VALUES('$name','$price','$image')");
...
if (isset($_GET['delete'])) {
    ...
    mysqli_query($conn, "DELETE FROM `tblaudioproducts` WHERE id = '$delete_id'") or die('query failed');
...
if (isset($_POST['update_product'])) {
    ...
    mysqli_query($conn, "UPDATE `tblaudioproducts` SET name = '$update_name', price = '$update_price' WHERE id = '$update_p_id'") or die('query failed');
    ...
    if (!empty($update_image)) {
        ...
        if ($update_image_size > 2000000) {
            ...
            //SQL query to update record on the tblbooks table
            mysqli_query($conn, "UPDATE `tblaudioproducts` SET image = '$update_image' WHERE id = '$update_p_id'") or die('query failed');
...
<body>
    ...
    <section class="add-products">
        <h1 class="title">Discount Audio Products</h1>
    ...
    <section class="show-products">
        ...
        <div class="box_container">
            ...
            <?php
            $select_products = mysqli_query($conn, "SELECT * FROM `tblaudioproducts`") or die('Quesry failed');
    ...
    <section class="edit-product-form">
        ...
        if (isset($_GET['update'])) {
            ...
            $update_query = mysqli_query($conn, "SELECT * FROM `tblaudioproducts` WHERE id = '$update_id'") or die('query failed');
